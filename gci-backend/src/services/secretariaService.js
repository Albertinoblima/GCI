...
const secretariaService = {
    ...
    ,
    /**
     * Lista secretarias ativas de um município
     * @param {number} municipioId
     * @returns {Promise<Array>} Lista de secretarias ativas
     */
    async listarAtivasPorMunicipio(municipioId) {
        // Busca todas as secretarias ativas para o município
        return await secretariaRepository.findByMunicipioId(municipioId, { ativo: true });
    }
};
